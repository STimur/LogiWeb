...
public class DriverServiceTest {
    ...
    public void GetFreeDriversForOrder() {
        ...
        Assert.assertTrue(driversNotOnOrder.size()==1);
        Assert.assertEquals(3, driversNotOnOrder.get(0).getId());
    ...
    public void GetDriversInSameCityAsOrder() {
        ...
        Assert.assertEquals(2, driversInSameCityAsAssignedTruck.get(1).getId());
        Assert.assertEquals(3, driversInSameCityAsAssignedTruck.get(2).getId());
    ...
    public void GetDriversWhichHaveEnoughTimeForOrder() {
        ...
        Assert.assertEquals(3, driversWhichHaveEnoughTimeForOrder.get(1).getId());
    ...
    public void GetSuitableDrivers() {
        ...
        Assert.assertTrue(driversWhichHaveEnoughTimeForOrder.size()==1);
        Assert.assertEquals(3, driversWhichHaveEnoughTimeForOrder.get(0).getId());
